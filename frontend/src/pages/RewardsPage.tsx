  ...
  return (
    <main className="flex flex-1 flex-col gap-5 px-4 pb-6 pt-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        {attendance && (
          <section className="relative col-span-2 flex flex-col gap-4 overflow-hidden rounded-3xl border border-slate-800 bg-slate-900 p-5 sm:col-span-1">
        ...
        <section className="col-span-2 flex flex-col gap-2 rounded-3xl border border-slate-800 bg-slate-900 p-5 opacity-60 sm:col-span-1">
          <div className="flex items-center justify-between">
