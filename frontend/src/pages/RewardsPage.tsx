  ...
  return (
    <main className="flex flex-1 flex-col gap-5 px-4 pb-6 pt-5">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-xs text-neutral-400">매일 출석하고, 다양한 혜택을 받아보세요</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        {attendance && (
          <section className="relative col-span-2 flex flex-col gap-4 overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-900 p-5 transition-colors hover:bg-neutral-800/70 active:bg-neutral-700/70 sm:col-span-1">
        ...
        <section className="col-span-2 flex flex-col gap-2 rounded-3xl border border-neutral-800 bg-neutral-900 p-5 opacity-60 transition-colors hover:bg-neutral-800/70 active:bg-neutral-700/70 sm:col-span-1">
          <div className="flex items-center justify-between">
          ...
          <p className="text-xs text-neutral-500">친구를 초대하면 서로 크레딧 보상을 받을 수 있어요</p>
        </section>
      </div>

      <section className="flex flex-col gap-1.5 rounded-2xl border border-neutral-800 bg-neutral-900 p-4 text-[11px] text-neutral-500">
        <h4 className="mb-1 text-xs font-bold text-neutral-300">안내사항</h4>
