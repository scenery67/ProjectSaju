import { Flame, Lightbulb, Moon, Sparkles, Star, type LucideIcon } from 'lucide-react';
...
const PROGRESS_ICONS: LucideIcon[] = [Sparkles, Star, Moon, Flame];
...
export default function PersonaDetailPage() {
  ...
  const { progress, message, icon: ProgressIcon, tip, start } = useFakeProgress(
    submitting,
